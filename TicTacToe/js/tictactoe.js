...
let activePlayer = 'X';
////This array stores an array ofmoves. we use this to determine win conditions
let selectedSquares = [];

//This function is for placing an x or an o in a square
function placeXOrO(squareNumber) {
    //Tis condition ensures a square hasn't been selected already.
    ...
    function computersTurn() {
        ...
        while (!success) {
         ...
         //THis function parses the selectedSquares array to search for win condidions
        ...
        //9 squares are selected the code executes
            ...
            audio('./media/tie.mp3');
            //This function sets a .3 second timer befor the resetGame is called
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //then true is returned and our else if conditio executes the drawLine() function
        if (a === true && b == true && c == true) { return true; }
        }

    }

//This function makes our body elelment temp unclickable
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    //This line accesses our HTML canvas elelment
    const canvas = document.getElementById('win-lines');
    //This lines gives us access to methods and properties to use on canvas
    const c = canvas.getContext('2d');
    //This line indicates where the start of a linees axis is
    let x1 = coordX1,
    ...
    function animateLineDrawing() {
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            //This is necessary for the 6, 4, 2 win coditions
...
function resetGame() {
    //This for loop iterates through eachHTML square element
    for (let i = 0; i < 9; i++) {
